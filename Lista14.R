...
##############################
# zadanie1 – model regresji ceny za m2
# dane: mieszkania.csv
##############################
...
##############################
# zadanie2 – model regresji dla całkowitej ceny
##############################
...
##############################
# zadanie3 – bakteria.csv
##############################

# a) wykres rozrzutu masy względem czasu
bakt <- read.csv("bakteria.csv", sep = ";")
cat("\nZadanie3_a: Wykres rozrzutu\n")
